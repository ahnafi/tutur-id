...
export default function EditStoryPage({ story, categories, regions }: EditStoryPageProps) {
    const [imagePreview, setImagePreview] = useState<string | null>(
        story.image ? `/storage${story.image}` : null
    );
                ...
                <div className="mb-8">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-muted-foreground">
                            Perbarui informasi cerita Anda
                        </p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Edit detail cerita yang ingin Anda perbarui
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    <Select 
                                        value={data.origin_place} 
                                        onValueChange={(value) => setData('origin_place', value)}
                                    >
                                    ...
                                    {errors.origin_place && (
                                        <p className="text-sm text-red-500">{errors.origin_place}</p>
                                    )}
                                </div>
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                {errors.gmaps_link && (
                                    <p className="text-sm text-red-500">{errors.gmaps_link}</p>
                                )}
                            </div>
                        </CardContent>
                    </Card>
