                            ...
                            <div className="space-y-6">
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-4">
                                        ...
                                        <Separator />
                                        <div className="text-center">
                                            <div className="mb-1 text-2xl font-bold text-primary">{Math.round((stats.storiesRead / 100) * 100)}%</div>
                                    ...
                                    {contributions.map((contribution) => (
                                        <div key={contribution.id} className="relative rounded-lg border p-4">
                                            ...
                                            <div className="mt-2 flex gap-2">
                                                ...
                                                <Button variant="outline" size="sm" asChild>
                                                    <Link href={`/cerita/${contribution.slug}/edit`}>
                                                        <Edit className="mr-2 h-4 w-4" />
                                                        Edit
                                                    </Link>
                                                </Button>
                                                <Dialog>
                                                    ...
                                                    <DialogContent>
                                                        <DialogHeader>
                                                            ...
                                                            <DialogDescription>
                                                                Apakah Anda yakin ingin menghapus cerita "{contribution.title}"? Tindakan ini tidak
                                                                dapat dibatalkan.
                                                            </DialogDescription>
                                                        </DialogHeader>
                                                        <DialogFooter>
                    ...
                    <TabsContent value="settings">
                        <Card>
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    <h3 className="font-medium text-red-600">Zona Bahaya</h3>
                                    <div className="space-y-3">
                                        <Button variant="outline" className="border-red-200 bg-transparent text-red-600 hover:bg-red-50">
                                            Hapus Akun
                                        </Button>
                                    </div>
                                </div>
